...
class KasirBukuCerita extends StatefulWidget {
  const KasirBukuCerita({Key? key}) : super(key: key);

  @override
  _KasirBukuCeritaState createState() => _KasirBukuCeritaState();
}

class _KasirBukuCeritaState extends State<KasirBukuCerita> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('product')
            .where('category', isEqualTo: 'Buku Cerita')
            .snapshots(),
