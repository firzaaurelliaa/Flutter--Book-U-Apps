...
class KasirPenggaris extends StatefulWidget {
  const KasirPenggaris({Key? key}) : super(key: key);

  @override
  _KasirPenggarisState createState() => _KasirPenggarisState();
}

class _KasirPenggarisState extends State<KasirPenggaris> {
  @override
