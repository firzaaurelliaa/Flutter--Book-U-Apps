...
class KasirBukuPelajaran extends StatefulWidget {
  const KasirBukuPelajaran({Key? key}) : super(key: key);

  @override
  _KasirBukuPelajaranState createState() => _KasirBukuPelajaranState();
}

class _KasirBukuPelajaranState extends State<KasirBukuPelajaran> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('product')
            .where('category', isEqualTo: 'Buku Pelajaran')
            .snapshots(),
