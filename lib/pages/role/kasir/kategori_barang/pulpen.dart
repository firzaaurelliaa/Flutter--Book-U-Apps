...
class KasirPulpen extends StatefulWidget {
  const KasirPulpen({Key? key}) : super(key: key);

  @override
  _KasirPulpenState createState() => _KasirPulpenState();
}

class _KasirPulpenState extends State<KasirPulpen> {
  @override
