...
class AdminBukuNovel extends StatefulWidget {
  const AdminBukuNovel({Key? key}) : super(key: key);

  @override
  _AdminBukuNovelState createState() => _AdminBukuNovelState();
}

class _AdminBukuNovelState extends State<AdminBukuNovel> {
  @override
