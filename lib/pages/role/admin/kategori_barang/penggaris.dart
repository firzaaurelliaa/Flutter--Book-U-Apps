...
class AdminPenggaris extends StatefulWidget {
  const AdminPenggaris({Key? key}) : super(key: key);

  @override
  _AdminPenggarisState createState() => _AdminPenggarisState();
}

class _AdminPenggarisState extends State<AdminPenggaris> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('product')
            .where('category', isEqualTo: 'Penggaris')
            .snapshots(),
