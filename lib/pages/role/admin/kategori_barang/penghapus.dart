...
class AdminPenghapus extends StatefulWidget {
  const AdminPenghapus({Key? key}) : super(key: key);

  @override
  _AdminPenghapusState createState() => _AdminPenghapusState();
}

class _AdminPenghapusState extends State<AdminPenghapus> {
  @override
